...
namespace _8harjoitus
{
    public partial class Roomalaisiksiform : Form
    {
        ...
        private void muutaBT_Click(object sender, EventArgs e)
        {
            ...
            string vastaus = "";
            if (numeroTB.Text.Length > 3) //kyseessä on tuhatluku
            {
            ...
            else if (numeroTB.Text.Length > 2)//kyseessä on sataluku
            {
                ...
                luku3 = Convert.ToInt32(numeroTB.Text.Substring(1, 1));//kympit
            ...
            else if (numeroTB.Text.Length > 1)//kyseessä on kymppiluku
            {
                luku3 = Convert.ToInt32(numeroTB.Text.Substring(0, 1));//kympit
                luku4 = Convert.ToInt32(numeroTB.Text.Substring(1, 1));//ykköset
                vastaus += kympit(luku3, vastaus);
                vastaus += ykkoset(luku4, vastaus);
            }
            else if (numeroTB.Text.Length > 0)//kyseessä on ykköisluku
            {
